...
module.exports = {
  rules: [
    { p: 'dall|image|flux|stable-?diffusion|sd(xl)?[-_]|midjourney|ideogram|kolors|seedream', caps: ['image_generation'] },
    { p: 'video|kling|runway|pika|seedance|^wan|sora|gen-|animate', caps: ['video_generation'] },
    ...
    { p: 'edit|inpaint|outpaint', caps: ['image_edit'] },
